...
public class User {
    ...
    /**
     * Organization / Workspace to which this user belongs.
     *
     ...
     *     |-- Executive 2
     *
     * The database column generated by this relationship is:
     *
     * organization_id
     */
    ...
    /**
     * User who created this employee/user record.
     *
     * This is separate from the Organization relationship.
     */
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    /**
     * User who last modified this employee/user record.
     */
    @ManyToOne(fetch = FetchType.LAZY)
